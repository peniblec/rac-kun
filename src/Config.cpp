...
const unsigned int JOIN_NOTIF_GROUP_ID_LENGTH = CryptoPP::SHA1::DIGESTSIZE;

const unsigned int JOIN_NOTIF_ENDPOINT_OFFSET =
  // JOIN_NOTIF_GROUP_ID_OFFSET + JOIN_NOTIF_GROUP_ID_LENGTH;
  JOIN_MSG_KEY_OFFSET + JOIN_MSG_KEY_LENGTH;
